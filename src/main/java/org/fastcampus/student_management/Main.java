...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("바이올린", 1000, "MONDAY", "홍길동", 1717299808L);
    CourseInfoDto courseInfoDto2 = new CourseInfoDto("첼로", 1200, "MONDAY", "존도", 1717299888L);
